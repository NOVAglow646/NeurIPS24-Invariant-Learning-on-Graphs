"""
Implementation of the EER_M algorithm from `"Handling Distribution Shifts on Graphs: An Invariance Perspective" <https://arxiv.org/abs/2202.02466>`_ paper
"""
import torch
...
class EER_M(BaseOODAlg):
    r"""
    Implementation of the EER_M algorithm from `"Handling Distribution Shifts on Graphs: An Invariance Perspective"
    ...
    def __init__(self, config: Union[CommonArgs, Munch]):
        super(EER_M, self).__init__(config)
    ...
    def loss_postprocess(self, loss: Tensor, data: Batch, mask: Tensor, config: Union[CommonArgs, Munch], **kwargs) -> Tensor:
        r"""
        Process loss based on EER_M algorithm
