...
class CIGAdivGIN(GNNBasic):

    def __init__(self, config: Union[CommonArgs, Munch]):
        super(CIGAdivGIN, self).__init__(config)
...
@register.model_register
class CIGAdivvGINNC(CIGAdivGIN):
    """
    using a simple GNN to encode spurious subgraph
    """
    def __init__(self, config: Union[CommonArgs, Munch]):
        super(CIGAdivvGINNB, self).__init__(config)
...
@register.model_register
class CIGAdivvGIN(CIGAdivGIN):

    def __init__(self, config: Union[CommonArgs, Munch]):
        super(CIGAdivvGIN, self).__init__(config)
...
@register.model_register
class CIGAdivvGINNB(CIGAdivGIN):
