...
def main():
    ...
    #print(config)
    load_logger(config, sub_print=True) #If sub_print=true, redirect to GOOD/storage/log/round1/GOODCMNIST_color_concept/CIGAdivGIN_5l_meanpool_0.5dp/0.001lr_0.0wd/CIGAdiv_0.6_1_0.5/lb_sweeping.log
    #else, the terminal output will be direct to GOOD/debug_out.log
