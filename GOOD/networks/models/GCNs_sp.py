...
from .Classifiers import Classifier_sp

import torch_geometric


@register.model_register
class GCN_sp(GNNBasic):
    r"""
    ...
    def __init__(self, config: Union[CommonArgs, Munch]):
        ...
        self.classifier = Classifier_sp(config)
...
class GCNFeatExtractor(GNNBasic):
    ...
    def forward(self, *args, **kwargs):
        ...
        #print(F'#in#8888x={ x }, x.shape={x.shape}')
        ...
        if self.normalize:
            if isinstance(edge_index, Tensor):
                ...
                if cache is None:
                    ...
                    #print(F'#in#666x={ x }, x.shape={x.shape}')
