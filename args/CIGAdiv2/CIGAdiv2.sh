...
goodtl --sweep_root sweep_configs --launcher MultiLauncher --allow_datasets GOODCMNIST --allow_domains color --allow_shifts covariate --allow_algs CIGAdiv2 --allow_devices 8 9
